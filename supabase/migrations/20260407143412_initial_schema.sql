-- ============================================================
-- Best Basket — Initial Schema Migration
...
-- ============================================
-- 1. CREATE ALL TABLES
-- Tables are created first (without policies) so that
-- cross-table references in policies don't fail.
-- ============================================
...
create table list_items (
  ...
  checked boolean default false not null  -- shopping mode check-off
);
...
-- These run with elevated permissions.
-- Defined before policies because some policies reference them.
-- ============================================
...
-- ============================================
-- 3. RLS POLICIES
-- All tables and functions exist now, so cross-references are safe.
-- ============================================
...
-- Uses is_list_owner() to avoid infinite RLS recursion
-- (shopping_lists RLS references list_shares, so list_shares
-- can't reference shopping_lists back directly).
...
-- LIST CATEGORY SORT ORDER policies
